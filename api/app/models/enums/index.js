...
export const JOURNEY_STATUS = new Enum(["PENDING", "WAITING", "PICKUP_READY", "PICKED_UP", "IN_PROGRESS", "COMPLETED"]);
...
export const AFFILIATION_JOURNEY_STATUS_MAP = {
  ...
  [JOURNEY_STATUS.PICKED_UP]: AFFILIATION_STATUS.COMPLETED,
